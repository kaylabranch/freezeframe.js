(function (global, factory) {
  ...
  var _c0 = ["freezeRef"];
  var _c1 = ["slotRef"];
  function AngularFreezeframeComponent_div_4_Template(rf, ctx) {
      if (rf & 1) {
  ...
  AngularFreezeframeComponent.ɵcmp = i0.ɵɵdefineComponent({ type: AngularFreezeframeComponent, selectors: [["angular-freezeframe"]], viewQuery: function AngularFreezeframeComponent_Query(rf, ctx) {
      ...
      }, inputs: { src: "src", options: "options" }, outputs: { startEvent: "startEvent", stopEvent: "stopEvent", toggleEvent: "toggleEvent" }, ngContentSelectors: _c2, decls: 5, vars: 1, consts: [[1, "angular-freezeframe"], ["slotRef", ""], [4, "ngIf"], [3, "src"], ["freezeRef", ""]], template: function AngularFreezeframeComponent_Template(rf, ctx) {
          if (rf & 1) {
              i0.ɵɵprojectionDef();

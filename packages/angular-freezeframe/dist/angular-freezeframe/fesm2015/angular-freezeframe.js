import { ɵɵelementStart, ɵɵelement, ɵɵelementEnd, ɵɵnextContext, ɵɵadvance, ɵɵpropertyInterpolate, ɵɵsanitizeUrl, EventEmitter, ɵɵdefineComponent, ɵɵviewQuery, ɵɵqueryRefresh, ɵɵloadQuery, ɵɵprojectionDef, ɵɵprojection, ɵɵtemplate, ɵɵreference, ɵɵproperty, ɵsetClassMetadata, Component, Input, Output, ViewChild, ɵɵdefineNgModule, ɵɵdefineInjector, ɵɵsetNgModuleScope, NgModule } from '@angular/core';
...
AngularFreezeframeComponent.ɵcmp = ɵɵdefineComponent({ type: AngularFreezeframeComponent, selectors: [["angular-freezeframe"]], viewQuery: function AngularFreezeframeComponent_Query(rf, ctx) { if (rf & 1) {
        ...
        ɵɵprojection(3);
        ɵɵelementEnd();
        ɵɵtemplate(4, AngularFreezeframeComponent_div_4_Template, 3, 1, "div", 2);
        ɵɵelementEnd();
    } if (rf & 2) {
        const _r0 = ɵɵreference(2);
        ɵɵadvance(4);
        ɵɵproperty("ngIf", !_r0.innerHTML.trim());
    } }, encapsulation: 2 });
